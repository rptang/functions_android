package com.project.rptang.android.custom_upload_image;
...
public class CustomUploadImageActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_upload_image);
        img_pic = (ImageView) findViewById(R.id.img_pic);
        img_pic.setOnClickListener(this);
        context = CustomUploadImageActivity.this;
    }
