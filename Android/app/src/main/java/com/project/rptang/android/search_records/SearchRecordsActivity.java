...
public class SearchRecordsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_search.setOnKeyListener(new View.OnKeyListener() {// 输入完后按键盘上的搜索键
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {// 修改回车键功能
                    ...
                    Toast.makeText(SearchRecordsActivity.this, "clicked!", Toast.LENGTH_SHORT).show();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(SearchRecordsActivity.this, name, Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        listView = (com.project.rptang.android.search_records.MyListView) findViewById(R.id.listView);
